...
namespace mohammadnaghibi\Gateway\Mellat;

use DateTime;
use Illuminate\Support\Facades\Input;
use mohammadnaghibi\Gateway\Enum;
use SoapClient;
use mohammadnaghibi\Gateway\PortAbstract;
use mohammadnaghibi\Gateway\PortInterface;
...
class Mellat extends PortAbstract implements PortInterface
{
    ...
    protected function ReversalRequest()
    {
        ...
        if ($response->return == '0' || $response->return == '45') {
            $this->transactionReverse();
            $this->newLog($response->return, Enum::TRANSACTION_REVERSAL_TEXT);
            return true;
        }
